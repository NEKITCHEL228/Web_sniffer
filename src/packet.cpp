...
TcpPacket::TcpPacket(QString src, QString dest, int sz, int sPort, int dPort)
...
UdpPacket::UdpPacket(QString src, QString dest, int sz, int sPort, int dPort)
...
IcmpPacket::IcmpPacket(QString src, QString dest, int sz, int type)
